...
RSpec.describe "line_fragments/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit line_fragment form" do
    render

    assert_select "form[action=?][method=?]", line_fragment_path(@line_fragment), "post" do
