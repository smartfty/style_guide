RLayout::Container.new(width: 1028.976498, height: 41.70979114285714, layout_direction: 'horinoztal') do
  text('애드버토리얼', x: 464.0, y: 1, width: 100, font: 'YDVYMjOStd14',  font_size: 20, text_color: "#221E1F", text_alignment: 'center')
  text('2017년 5월 30일 화요일', x: 885.5693, y: 10,  width: 200, font: 'YDVYGOStd12', font_size: 9.5, text_color: "#221E1F", text_alignment: 'left')
  text('17', x: 988, y: 1, font: 'YDVYGOStd14', font_size: 24, text_color: "#221E1F", width: 40, height: 44, text_alignment: 'right')
