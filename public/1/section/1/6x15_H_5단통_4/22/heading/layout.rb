RLayout::Container.new(width: 1028.9763779528, height: 139.0326207874, layout_direction: 'horinoztal') do
  ...
  text('2017년 5월 11일 목요일 (4200호)', x: 828.00, y: 108, fill_color:'clear', width: 200, height: 12, font: 'KoPubDotumPL', font_size: 11, tracking: -0.9, font_color: "CMYK=0,0,0,100", text_alignment: 'right')
