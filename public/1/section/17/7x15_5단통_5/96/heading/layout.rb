RLayout::Container.new(width: 1028.9763779528, height: 41.385826771654, layout_direction: 'horinoztal') do
  ...
  t = text('특 집', font_size: 20.5, x: 464.0, y: -2, width: 100, font: 'KoPubBatangPM', text_color: "CMYK=0,0,0,100", fill_color:'clear', text_fit_type: 'fit_box_to_text', anchor_type: 'center')
  ...
  text('17', tracking: -0.2, x: 974.69, y: -8.97, font: 'Helvetica-Light', font_size: 36, text_color: "CMYK=0,0,0,100", width: 50, height: 44, fill_color:'clear', text_alignment: 'right')
  end