RLayout::Container.new(width: 1028.976498, height: 41.70979114285714, layout_direction: 'horinoztal') do
  text('기획', x: 464.0, y: 1, width: 100, font: 'YDVYMjOStd14',  font_size: 20, text_color: "CMYK=0,0,0,100", text_alignment: 'center')
  text('2017년 5월 11일 목요일', x: 900.5693, y: 10,  width: 200, font: 'YDVYGOStd12', font_size: 9.5, text_color: "CMYK=0,0,0,100", text_alignment: 'left')
  text('21', x: 998, y: 1, font: 'YDVYGOStd14', font_size: 24, text_color: "CMYK=0,0,0,100", width: 50, height: 44)
