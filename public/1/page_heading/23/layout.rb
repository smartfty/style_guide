RLayout::Container.new(width: 1028.9763779528, height: 55.613048314961, layout_direction: 'horinoztal') do
  ...
  text('0000년 0월 0일 0요일', x: 50.5693, y: 8.88,  width: 200, height: 12.16, font: 'KoPubDotumPL', text_color: "CMYK=0,0,0,100", tracking: -0.7, font_size: 10.5, text_alignment: 'left')
