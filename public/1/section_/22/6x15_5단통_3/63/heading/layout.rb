RLayout::Container.new(width: 1028.9763779528, height: 55.613048314961, layout_direction: 'horinoztal') do
  ...
  text('0000년 0월 0일 0요일', x: 864.104, y: 8.8, fill_color: 'clear', tracking: -0.7,  width: 110, height: 11, font: 'KoPubDotumPL', fill_color: 'clear', text_color: "CMYK=0,0,0,100", font_size: 10.5, text_alignment: 'right')
