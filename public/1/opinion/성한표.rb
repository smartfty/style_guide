RLayout::Container.new(width:158.737,  height: 165.182) do
  ...
  text('성한표 칼럼', x: 0, y:5, font: 'KoPubDotumPB', font_size: 12, width: 170)
  ...
  container(x: 70, y: 80, width:150, bottom_margin: 10, fill_color: 'clear') do
        ...
        text('성한표', y:17, font: 'KoPubDotumPB', font_size: 9, fill_color: 'clear')
      
      text('언론인', y:30, font: 'KoPubDotumPL', font_size: 8, fill_color: 'clear')
      text('전 한겨레 논설주간', y:41, font: 'KoPubDotumPL', font_size: 8, fill_color: 'clear')
