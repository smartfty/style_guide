RLayout::Container.new(width:158.737,  height: 165.182) do
  ...
  container(x: 70, y: 80, width:150, bottom_margin: 10, fill_color: 'clear') do
        ...
        text('양재찬', y:17, font: 'KoPubDotumPB', font_size: 9, fill_color: 'clear')
      
      text('한국외대 겸임교수', y:30, font: 'KoPubDotumPL', font_size: 8, fill_color: 'clear')
      text('경제저널리즘 박사', y:41, font: 'KoPubDotumPL', font_size: 8, fill_color: 'clear')
