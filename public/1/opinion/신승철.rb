RLayout::Container.new(width:171.496083,  height: 165.219) do
  ...
  container(x: 70, y: 80, width:150, bottom_margin: 10, fill_color: 'clear') do
        ...
        text('신승철', y:17, font: 'KoPubDotumPB', font_size: 9, fill_color: 'clear')
      
      text('중남미지역경제협력대사', y:30, font: 'KoPubDotumPL', font_size: 8, fill_color: 'clear')
      text('한/중남미협회장', y:41, font: 'KoPubDotumPL', font_size: 8, fill_color: 'clear')
