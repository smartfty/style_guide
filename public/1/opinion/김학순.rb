...
RLayout::Container.new(width:171.496083,  height: 165.219) do
  ...
  text('김학순의 세상톺아보기', y:5, font_size: 9)
  ...
  container(x: 70, y: 80, width:150, bottom_margin: 10, fill_color: 'clear') do
    text('김학순', y:15, font_size: 9, fill_color: 'clear')
    text('언론인/고려대', y:25, font_size: 9, fill_color: 'clear')
    text('미디어학부 초빙교수', y:35, font_size: 9, fill_color: 'clear') if true
  end
end
