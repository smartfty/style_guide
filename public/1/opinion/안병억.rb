...
RLayout::Container.new(width:171.496083,  height: 165.219) do
  ...
  container(x: 70, y: 80, width:150, bottom_margin: 10, fill_color: 'clear') do
    text('안병억', y:15, font_size: 9, fill_color: 'clear')
    text('대구대 교수 국제관계학', y:25, font_size: 9, fill_color: 'clear')
    text('안쌤의유로톡제작진행자', y:35, font_size: 9, fill_color: 'clear') if true
  end
end
