RLayout::Container.new(width:158.737,  height: 165.182) do
  ...
  container(x: 70, y: 80, width:150, bottom_margin: 10, fill_color: 'clear') do
        ...
        text('안병억', y:17, font: 'KoPubDotumPB', font_size: 9, fill_color: 'clear')
      
      text('대구대 교수 국제관계학', y:30, font: 'KoPubDotumPL', font_size: 8, fill_color: 'clear')
      text('안쌤의유로톡제작진행자', y:41, font: 'KoPubDotumPL', font_size: 8, fill_color: 'clear')
