RLayout::Container.new(width:171.496083,  height: 165.219) do
  ...
  container(x: 70, y: 80, width:150, bottom_margin: 10, fill_color: 'clear') do
        ...
        text('양승현', y:17, font: 'KoPubDotumPB', font_size: 9, fill_color: 'clear')
      
      text('가천대사회과학대학장', y:30, font: 'KoPubDotumPL', font_size: 8, fill_color: 'clear')
      text('미디어커뮤니케이션학', y:41, font: 'KoPubDotumPL', font_size: 8, fill_color: 'clear')
