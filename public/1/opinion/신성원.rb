RLayout::Container.new(width:171.496083,  height: 165.219) do
  ...
  container(x: 70, y: 80, width:150, bottom_margin: 10, fill_color: 'clear') do
        ...
        text('신성원', y:17, font: 'KoPubDotumPB', font_size: 9, fill_color: 'clear')
      
      text('국립외교원 외교안보연구소', y:30, font: 'KoPubDotumPL', font_size: 8, fill_color: 'clear')
      text('경제통상연구부장', y:41, font: 'KoPubDotumPL', font_size: 8, fill_color: 'clear')
