...
RLayout::Container.new(width:171.496083,  height: 165.219) do
  ...
  container(x: 70, y: 80, width:150, bottom_margin: 10, fill_color: 'clear') do
    text('이선진', y:15, font_size: 9, fill_color: 'clear')
    text('서강대동아연구소 교수', y:25, font_size: 9, fill_color: 'clear')
    text('전 주인도네시아 대사', y:35, font_size: 9, fill_color: 'clear') if true
  end
end
