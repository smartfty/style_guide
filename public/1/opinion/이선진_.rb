RLayout::Container.new(width:158.74015748031, height: 162.83914494488) do
  ...
  text('이선진 칼럼', x: 0, y:8, font: 'KoPubDotumPB', font_size: 12, width: 170, text_color:'CMYK=0,0,0,100')
  ...
  container(x: 70, y: 80, width:150, bottom_margin: 10, fill_color: 'clear') do
      ...
      text('전 주인도네이사 대사', y:41, font: 'KoPubDotumPL', font_size: 8, fill_color: 'clear', text_color:'CMYK=0,0,0,100')
