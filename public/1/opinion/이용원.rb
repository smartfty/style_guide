RLayout::Container.new(width:158.737,  height: 165.182) do
  ...
  text('이용원의 세상탐사', x: 0, y:5, font: 'KoPubDotumPB', font_size: 12, width: 170, text_color:"CMYK=0,0,0,100")
  ...
  container(x: 70, y: 80, width:150, bottom_margin: 10, fill_color: 'clear') do
      ...
      text('동국대 겸임교수', y:41, font: 'KoPubDotumPL', font_size: 8, fill_color: 'clear', text_color:"CMYK=0,0,0,100")
