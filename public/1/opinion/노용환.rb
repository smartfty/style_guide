RLayout::Container.new(width:158.737,  height: 165.182) do
  ...
  rect(x: 0, y: 70, width:158.737, height: 65,  fill_color:"CMYK=0,0,0,10")
    ...
    image(local_image: '노용환.eps', y: 60, width: 60, height: 75, fill_color: 'clear')
  
  container(x: 70, y: 80, width:150, bottom_margin: 10, fill_color: 'clear') do
    
      
        text('노용환', y:17, font: 'KoPubDotumPB', font_size: 9, fill_color: 'clear')
      
      text('서울여대 교수', y:30, font: 'KoPubDotumPL', font_size: 8, fill_color: 'clear')
