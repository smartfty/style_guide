...
RLayout::Container.new(width:171.496083,  height: 165.219) do
  ...
  container(x: 70, y: 80, width:150, bottom_margin: 10, fill_color: 'clear') do
    text('문송천', y:15, font_size: 9, fill_color: 'clear')
    text('카이스트', y:25, font_size: 9, fill_color: 'clear')
    text('경영대학원 교수', y:35, font_size: 9, fill_color: 'clear') if true
  end
end
