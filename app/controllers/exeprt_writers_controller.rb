class ExeprtWritersController < ApplicationController
  before_action :set_exeprt_writer, only: [:show, :edit, :update, :destroy]

  # GET /exeprt_writers
  # GET /exeprt_writers.json
  def index
    @exeprt_writers = ExeprtWriter.all
  end

  # GET /exeprt_writers/1
  # GET /exeprt_writers/1.json
  def show
  end

  # GET /exeprt_writers/new
  def new
    @exeprt_writer = ExeprtWriter.new
  end

  # GET /exeprt_writers/1/edit
  def edit
  end

  # POST /exeprt_writers
  # POST /exeprt_writers.json
  def create
  ...
  # PATCH/PUT /exeprt_writers/1
  # PATCH/PUT /exeprt_writers/1.json
  def update
    respond_to do |format|
  ...
  # DELETE /exeprt_writers/1
  # DELETE /exeprt_writers/1.json
  def destroy
    @exeprt_writer.destroy
    respond_to do |format|
      format.html { redirect_to exeprt_writers_url, notice: 'Exeprt writer was successfully destroyed.' }
