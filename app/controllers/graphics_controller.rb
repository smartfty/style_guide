class GraphicsController < ApplicationController
  ...
  private
    ...
    def graphic_params
      params.require(:graphic).permit(:grid_x, :grid_y, :column, :row, :extra_height_in_lines, :graphic, :caption, :source, :position, :page_number, :story_number, :working_article_id, :issue_id)
    end
end
